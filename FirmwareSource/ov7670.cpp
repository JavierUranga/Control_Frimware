...
void ov7670::Reset(void) {    
    ...
    delay(100);  //Añadido para dar tiempo después del reset
}
...
//       sccb_write(REG_MANV, 0x00);
    ...
    //PRUEBAS
   // sccb_write(0x11,0x00); //PCLK = XCLK/2
    sccb_write(0x11,B10000101);
    //sccb_write(0x12,0x01); // Bayer RAW
    //sccb_write(0x12,B00000101); // Processed Bayer RAW
    sccb_write(0x12,B00000000);
}
